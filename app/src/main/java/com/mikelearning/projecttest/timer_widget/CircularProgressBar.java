...
package com.mikelearning.projecttest.timer_widget;
...
public class CircularProgressBar extends ProgressBar{
	...
	private boolean stop,pause,resume;
	...
	public void animateProgressTo(final int start, final int end, final ProgressAnimationListener listener){
		...
		progressBarAnimator.setDuration(30000);
		...
		progressBarAnimator.addUpdateListener(new AnimatorUpdateListener() {
			...
			public void onAnimationUpdate(final ValueAnimator animation) {
				if (!stop) {
					...
					progressBarAnimator.setDuration(0);
					CircularProgressBar.this.setProgress(0);
					if (listener != null)
						listener.onAnimationProgress(0);
				}
			}
		});
